 ...
 * @define {string}
 */
const CONFIGURATION_SERVER_URL = 'https://nexus.passport.com/rdr/pprdr.asp';
...
class PassportHandler {
     ...
     * Copied from: https://developer.mozilla.org/de/docs/Web/JavaScript/Reference/Global_Objects/encodeURIComponent
     *
     ...
     */
    getClient() {
        return this.httpClient || (this.httpClient = axios.create({
            maxRedirects: 0,
    ...
    async sendSignInRequestMessage(customtoken) {
        ...
        this.passportSession.signInAttempts++;
